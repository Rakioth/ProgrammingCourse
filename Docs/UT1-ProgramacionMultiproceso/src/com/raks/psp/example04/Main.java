...
public class Main {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        var process1  = new ProcessBuilder("java", "-cp", classPath, Adder.class.getName()).start();
        var process2  = new ProcessBuilder("java", "-cp", classPath, Adder.class.getName()).start();
