INSERT INTO album(title, genre, release_date, sales, has_vinyl)
VALUES ('ASTROWORLD', 'HIPHOP', '20180803', 4907811.67, true),
       ('Her Loss', 'POP', '20221104', 2457811.79, false);

INSERT INTO artist(name, birth_date, city, monthly_listeners, label)
...
INSERT INTO song(name, time, album_id)
